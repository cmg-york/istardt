...
<sch:schema
  ...
  <sch:pattern id="CheckBooleanExpressionAtoms">
    ...
    <sch:rule context="istar-t:boolAtom[
    ancestor::istar-t:preBox/istar-t:formula or
    ancestor::istar-t:indirectEffect/istar-t:formula
  ]">
  ...
  <sch:pattern id="CheckPreNprFormulaBoolAtoms">
    <sch:rule context="istar-t:boolAtom[
    ancestor::istar-t:goal/istar-t:pre/istar-t:formula or
    ancestor::istar-t:goal/istar-t:npr/istar-t:formula or
    ancestor::istar-t:task/istar-t:pre/istar-t:formula or
    ancestor::istar-t:task/istar-t:npr/istar-t:formula or
    ancestor::istar-t:effect/istar-t:pre/istar-t:formula or
    ancestor::istar-t:effect/istar-t:npr/istar-t:formula
  ]">
      <sch:let name="actor" value="ancestor::istar-t:actor"/>
      <sch:let name="boolAtom" value="normalize-space(.)"/>
      <sch:let name="preBoxNames" value="$actor//istar-t:preBox/@name"/>
      <sch:let name="goalNames" value="$actor//istar-t:goal/@name"/>
      <sch:let name="taskNames" value="$actor//istar-t:task/@name"/>
      <sch:let name="effectNames" value="$actor//istar-t:effectGroup/istar-t:effect/@name"/>
      <sch:let name="predicateNames" value="$actor//istar-t:predicates/istar-t:predicate/normalize-space(.)"/>
